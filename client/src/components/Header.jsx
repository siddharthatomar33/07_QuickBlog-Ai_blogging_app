  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        <div className='text-center mt-20 mb-8'>
          ...
          <p className='my-6sm:my-8 max-w-2xl m-auto max-sm:text-xs text-grey-500'>This is your space to think out loud, toshare what matters, 
            and to write without filters. whenever it's one word or a thousand, your story starts right here</p>
